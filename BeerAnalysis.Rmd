...
The first question to answer for the BAA was how many breweries are their in the USA and what is their location. The results indicate which states may be over populated with breweries and states that have not seen a wild growth in breweries. This is beneficial in determining which market to target based on saturation.
